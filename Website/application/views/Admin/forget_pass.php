...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/jquery.nivo.slider.js">
...
<div class="main">  	
						...
						<?php echo form_open_multipart('Verify'); ?>		
						<?php            if($msg != '') {		
						echo "<div class='alert alert-".$type."'><button class='close' data-dismiss='alert' type='button'>&times;</button>".$msg."</div>"; 				}          ?>
						...
						<div>	   
						<span><center><input type="submit" value="Send My Password"  class="button123"></center></span>	
						</div>			
						<?php echo form_close(); ?>		
						</div>  				</div>		
						</div>    
