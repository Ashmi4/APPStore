				...
				<div class="header_top">
					<div class="logo">
						...
						<ul>
							...
							<li><a class="active" href="<?php echo base_url();?>Register">Register</a></li>						
 ...
 <h3> <i class="fa fa-user fa-4x aria-hidden="true"></i> </h3>
          ...
          ?>
						    ...
						    <div>
						    	...
						    	<span><input name="password" type="password" class="textbox" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters"></span>(Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters)
						    </div>
						    <div>
						   ...
						   <div>
						   		<span><input type="submit" value="Create An Account"  class="button1234"></span>
						  </div>
					   <?php echo form_close(); ?>
				  </div>
  				</div>
