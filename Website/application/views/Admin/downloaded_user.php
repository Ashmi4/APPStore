					...
					<div class="logo">
						...
						<div class="search_box">
						  ...
						  <div class="account_desc">
							...
							<ul>
							<li><a class="active" href="<?php echo base_url();?>Apps/collection">My Apps</a></li>							
    ...
    <ul>
      ...
      <div class="content">
		...
		<?php 
		   ...
		   <?php			
			foreach($uu_app->Result() as $row){
				if(in_array(array($row->aid), $result2)){      
				...
				<div class="grid_1_of_5 images_1_of_5">
					...
					<a href="<?php echo base_url(); ?>Apps/details/<?php echo $row->aid; ?>"><img src="<?php echo $row->wapp_image; ?>" alt=""></a> 
					<h5 class="mess"><?php echo $row->wappname; ?></h5>
					 <h6 class="mess"><?php echo $row->wname; ?></h6>
					<div class="price-details">
				       <div class="staricon">								
									...
									<div>
								<span><input name="id" value="<?php echo $row->aid; ?>" type="hidden" class="textbox" ></span>
								</div>
								<input name="name" value="<?php echo $row->wname; ?>" type="hidden" class="textbox" >
								<?php 
