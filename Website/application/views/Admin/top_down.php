...
<div class="content_top">
    ...
    <ul>
       ...
       <li>
            <a class="active" class="top-heading " href="<?php echo base_url();?>Apps/topdownload">Top Downloads</a>
      ...
      <div class="content">
    	<div class="">
    		<div class="heading">
    		<h2  class="heading">Top Downloads Apps </h2>
    		</div>
    	</div>
		...
		<?php 
	      ...
	      <div class="section group">
		   <?php foreach($top_down->Result() as $data){
