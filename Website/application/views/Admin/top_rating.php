...
<div class="content_top">
   ...
   <ul>
       ...
       <li>
		...
		<li class="no-sub">
            <a class="active" class="top-heading " href="<?php echo base_url();?>Apps/top">Top Rated Apps</a>
        </li>
      ...
      <div class="content">
    	<div class="">
    		<div class="heading">
    		<h2  class="heading">Top Rated Apps</h2>
    		</div>
    	</div>
		...
		<?php 
	      ...
	      <div class="section group">
		   <?php foreach($top_rating->Result() as $data){
