					...
					<div class="logo">
						...
						<div class="search_box">
						  ...
						  <div class="account_desc">
							...
							<li><a class="active" href="<?php echo base_url(); ?>Logout"><i class="icon-switch2"></i> Logout</a></li>
						</ul>
   ...
   <ul>
        ...
        <li class="full-width">
			...
			<?php
                    ...
                    <ul class="column">                        
                        <li><a href="<?php echo base_url();?>Category/<?php echo $row->id; ?>"><?php echo $row->name; ?></a></li>					 
                    </ul>
					<?php   } ?>
                </div>
				...
				<div class="col span_2_of_3_a">
				  <div class="contact-form1">
				  	<div class="text-center">	
						<h3><i class="fa fa-user fa-4x" aria-hidden="true"></i></h3>	
						<h2 class="text-center">Login Here</h2>
                                                <h3 style="color:#F7F9F9;">You can reset your password here.</h3>
						
						</div>

						
	 <form action="<?php echo base_url(); ?>LoginCheck" id="sign_in" method="POST">
                       <?php
          ...
          ?>
					    	<div>
						    	...
						    	<span><input name="email" type="text" value ="" class="textbox" required pattern = "[^@]+@[^@]+\.[a-zA-Z]{2,4}"></span>
						    </div>
							<div>
						     	<span><label>Password</label></span>
						    	<span><input name="password" type="password" value ="" class="textbox" ></span>
						    </div>
							<div>
						   		<span><input type="submit" value="Sign In"  class="mybutton"></span>
								
						  </div>
						  <div  style=" margin-left: 146px;margin-top: 30px;">
						  ...
						  <div>
						  <span><a href="<?php echo base_url(); ?>Forgot-password">Forgotten your password?</a></span>
						  </div>
						  <div>
						  <span>NOT REGISTERED?<a href="<?php echo base_url();?>Register"> CREATE AN ACCOUNT</a></span>
						  </div>
					    </form>
