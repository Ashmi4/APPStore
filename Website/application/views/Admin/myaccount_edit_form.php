					...
					<div class="logo">
						...
						<div class="search_box">
						  ...
						  <div class="account_desc">
							...
							<li><a class="active" href="<?php echo base_url();?>Myaccount">My Account</a></li>											
				...
				<div class="col span_2_of_3_a">
				  <div class="contact-form1">
				  	...
				  	<h2></h2>
                          ...
                          <h3><img class="images1" src="<?php echo $_SESSION["image"]; ?>" alt="">	</h3>
						
                                          </div>
					  <?php echo form_open_multipart('StarAdmin/Updateaccount'); ?>
					  <?php
           if($msg != '') { echo "<div class='alert alert-".$type."'><button class='close' data-dismiss='alert' type='button'>&times;</button>".$msg."</div>"; }
          ?>
								<input name="userid" type="hidden" value="<?php echo $_SESSION["userid"]; ?>" class="textbox" required>
					    	<div>
						    	<span><label>Name</label></span>
						    	<span><input name="name" type="text" value="<?php echo $_SESSION["uName"]; ?>" class="textbox" required></span>
						    </div>
						    <div>
						    	<span><label>E-mail Address</label></span>
						    	<span><input name="email" type="text" value="<?php echo $_SESSION["email"]; ?>" class="textbox" required pattern = "[^@]+@[^@]+\.[a-zA-Z]{2,4}"></span>
						    </div>
							<div>
						    	<span><label>Company Name</label></span>
						    	<span><input name="address" type="text" value="<?php echo $_SESSION["address"]; ?>" class="textbox" required></span>
						    </div>
							
						    <div>
						     	<span><label>Password</label></span>
						    	<span><input name="password" value="<?php echo set_value('password'); ?>" type="password" class="textbox" required></span>
						    </div>
						    <div>
						   ...
						   <div>
						   		<span><input type="submit" value="Update"  class="button123"></span>
						  </div>
					   <?php echo form_close(); ?>
				  </div>
  				</div>
