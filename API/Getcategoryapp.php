...
if(!empty($id) AND !empty($userid) ){
	...
	$a_name= mb_convert_encoding($appname, "UTF-8", "HTML-ENTITIES");
		...
		$qur = mysql_query("SELECT ref,appid,appname,app_image,app_video,screenshot,app_description,version,price,rank,count,download,created_app,id,name,description FROM app_master JOIN category_master ON category_master.id=app_master.appid WHERE category_master.id='$id' LIMIT $limit,$start");
	...
	$c1 =count($result44);
			...
			$qur = mysql_query("SELECT ref,appid,appname,app_image,app_video,screenshot,app_description,version,price,rank,count,download,created_app,id,name,description FROM app_master JOIN category_master ON category_master.id=app_master.appid LIMIT $limit,$start");
