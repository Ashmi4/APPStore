...
<div class="pro-head1">
		...
		<hr>
				<?php echo form_open_multipart('StarAdmin/Savebanner'); ?>
                      <label>Name :</label> 
					<input type="text" name="name" value="<?php echo set_value('name'); ?>" placeholder="Name">
					
					 <label>Image :</label>
					<input name="image"  onchange="loadFile(event)" type="file" class="file-styled"><span style="-moz-user-select: none;" class="filename"></span>
						<img id="output" />
		      ...
		      <ul id="menu" >
		        ...
		        <li id="menu-comunicacao"><a href="<?php echo base_url(); ?>index.php/StarAdmin/App"><i class="fa fa-android"></i><span>Applications</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          ...
		          <li><a href="<?php echo base_url(); ?>index.php/StarAdmin/Users"><i class="fa fa-users"></i><span>Users</span></a></li>
				    <li class="active"><a href="<?php echo base_url(); ?>index.php/StarAdmin/Banner"><i class="fa fa-picture-o"></i><span>Banners</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
