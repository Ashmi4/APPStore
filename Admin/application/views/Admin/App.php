...
<div class="product-block">
 ...
 <?php foreach($results as $data){?>	
	...
	<a href="<?php echo $data->app_image; ?>" data-lightbox-gallery="gallery1" id="nivo-lightbox-demo"><span class="rollover1"> </span> 
	</a></p>
	</div>
	<img class="img-responsive" src="<?php echo $data->app_image; ?>" alt="">	
	</div>	
	<div class="produ-cost">
	<h4><?php echo $data->appname; ?></h4>
	...
	<hh> <?php echo $data->price; ?> &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url(); ?>index.php/StarAdmin/FetchApp/<?php echo $data->ref; ?>"><i class="fa fa-pencil"></i></a>
	<a href="<?php echo base_url(); ?>index.php/StarAdmin/DeleteApp/<?php echo $data->ref; ?>"><i class="fa fa-times"></i></a></hh>	    		
	</div>    
	</div>    
	</div>  	
	  	<?php } ?>	  
