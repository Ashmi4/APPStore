...
<hr>	
	...
	<div id="nivo-lightbox-demo"> <p>
					...
					if($data->icon_72 == '0'){?>
						...
						<img class="img-responsive1" src="<?php echo base_url(); ?>image/App/<?php echo $data->image_small; ?>" alt="">
					<?php }	?>



	<img class="img-responsive1" src="<?php echo $data->icon_72; ?>" alt="">	

	</div>	
	<div class="produ-cost">
	<h5><?php echo $data->title; ?>
		</h5>
	<?php if (round($data->rating)==1){ ?>
		<h5><i class="fa fa-star" aria-hidden="true"></i>
								   <i class="fa fa-star-o" aria-hidden="true"></i>
								   <i class="fa fa-star-o" aria-hidden="true"></i>
								   <i class="fa fa-star-o" aria-hidden="true"></i>
								   <i class="fa fa-star-o" aria-hidden="true"></i></h5>
<hh><a href="<?php echo base_url(); ?>index.php/StarAdmin/FetchgApp/<?php echo $data->id; ?>"><i class="fa fa-pencil"></i></a>   <a href="<?php echo base_url(); ?>index.php/StarAdmin/DeletegApp/<?php echo $data->id; ?>"><i class="fa fa-times"></i></a>	</hh>	
 <?php } ?>
<?php if (round($data->rating)==2){ ?>
		<h5><i class="fa fa-star" aria-hidden="true"></i>
