...
<div class="pro-head1">
		...
		<hr>
					<?php echo form_open_multipart('StarAdmin/UpdategApp'); ?>
							<?php foreach($gApp->Result() as $row) { ?>
		
							<input name="idd" type="hidden" value="<?php echo $row->id; ?>">				
									
                      <label>Application Name :</label> 
					<input type="text" name="title" value="<?php echo $row->title; ?>" placeholder="Name">
					
					<label>Icon :</label>
					<?php
					if($row->icon == '0'){?>
						<img src="<?php echo base_url(); ?>image/App/<?php echo $row->image; ?>">
						<?php }
						else{
						?>
					...
					<input  name="image" value="<?php echo set_value('image'); ?>" type="file" class="file-styled"><span style="-moz-user-select: none;" class="filename"></span>
								
					
					 <label>Icon_small :</label>
					<?php
					if($row->icon_72 == '0'){?>
						<img src="<?php echo base_url(); ?>image/App/<?php echo $row->image_small; ?>">
						<?php }
						else{
						?>
						
					
						<img src="<?php echo $row->icon_72; ?>">
						
						<?php }	?>
					
									
					<input  name="image_small" value="<?php echo set_value('image_small'); ?>" type="file" class="file-styled"><span style="-moz-user-select: none;" class="filename"></span>
											
					 	
					 <label>Description :</label>
					<textarea class="textarea1" name ="description" value="<?php echo $row->description; ?>" rows="5" cols="15" placeholder="Enter your Description here"><?php echo $row->description; ?></textarea>
