...
<div class="pro-head1">
		...
		<hr>
					<?php echo form_open_multipart('StarAdmin/UpdateApp'); ?>
							<?php foreach($App->Result() as $row) { ?>
		
											
									
                      <label>Application Name :</label> 
					<input type="text" name="appname" value="<?php echo $row->appname; ?>" placeholder="Name">
					
					 <label>Image :</label>
					 <img src="<?php echo $row->app_image ?>"></img>
									<input name="img_id" type="hidden" value="<?php echo $row->ref; ?>">
					<input  name="app_image" value="<?php echo $row->app_image; ?>" type="file" class="file-styled"><span style="-moz-user-select: none;" class="filename"></span>
					 ...
					 <?php
							 ...
							 foreach ($array as $item) {?>
							  ...
							  <span class="light1"><img src="<?php echo $item; ?>"></span>
					...
					<input name="screenshot" value="<?php echo $row->screenshot; ?>" type="file" class="file-styled"><span style="-moz-user-select: none;" class="filename"></span>
										
					 <label>Video :</label>
					<input name="app_video" type="file" class="file-styled"><span style="-moz-user-select: none;" class="filename"></span>
											
					 <label>Description :</label>
					<textarea class="textarea1" name ="app_description" value="<?php echo $row->app_description; ?>" rows="5" cols="15" placeholder="Enter your Description here"><?php echo $row->app_description; ?></textarea>
						<label>Price :</label> 
